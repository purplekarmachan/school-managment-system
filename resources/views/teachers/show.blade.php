...
@section('header-title', 'Teacher Details')
@section('header-subtitle', 'View teacher information')
            ...
            <div class="px-4 py-5 sm:p-6">
                <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-1">
                    <div class="sm:col-span-1">
                        ...
                        <dd class="mt-1 text-sm text-gray-900">{{ $teacher->first_name }} {{ $teacher->last_name }}</dd>
                    </div>
                    <div class="sm:col-span-1">
                        <dt class="text-sm font-medium text-gray-500">Date of Birth</dt>
                        <dd class="mt-1 text-sm text-gray-900">{{ $teacher->date_of_birth->format('F j, Y') }}</dd>
                    </div>
                    <div class="sm:col-span-1">
                        ...
                        <dd class="mt-1 text-sm text-gray-900">
                            ...
                            @else
                                <span class="text-gray-500">No courses found</span>
                            @endif
                        </dd>
                    </div>
                    <div class="sm:col-span-1">
                        ...
                        <dd class="mt-1 text-sm text-gray-900">
                            {{ $teacher->address->name }} {{ $teacher->address->number }}, 
                            {{ $teacher->address->city }} {{ $teacher->address->zipcode }}
                        </dd>
                    </div>
                
                    <div class="sm:col-span-1">
                        <dt class="text-sm font-medium text-gray-500">Created At</dt>
                        <dd class="mt-1 text-sm text-gray-900">{{ $teacher->created_at->format('F j, Y') }}</dd>
                    </div>
                    <div class="sm:col-span-1">
                        <dt class="text-sm font-medium text-gray-500">Last Updated</dt>
                        <dd class="mt-1 text-sm text-gray-900">{{ $teacher->updated_at->format('F j, Y') }}</dd>
                    </div>
                </dl>
            </div>
        </div>
