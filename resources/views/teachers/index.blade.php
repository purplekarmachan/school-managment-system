...
@section('header-title', 'Teachers')
@section('header-subtitle', 'Manage teacher records')
                        ...
                        @forelse($teachers as $teacher)
                            <tr>
                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">{{ $teacher->first_name }}
                                        {{ $teacher->last_name }}</div>
                                </td>
                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $teacher->date_of_birth->format('F j, Y') }}</div>
                                </td>
                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">
                                        {{ $teacher->address->street_name }} {{ $teacher->address->number }},
