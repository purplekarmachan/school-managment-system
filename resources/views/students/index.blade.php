...
@section('header-subtitle', 'Manage student records')
                        ...
                        @forelse($students as $student)
                            <tr>
                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">{{ $student->first_name }}
                                ...
                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $student->address->name }}
                                        {{ $student->address->number }}, {{ $student->address->city }}</div>
                                </td>
                                <td
