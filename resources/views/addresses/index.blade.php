...
@section('header-title', 'Addresses')
@section('header-subtitle', 'Manage your addresses')
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead>
                <tr class="bg-gradient-to-r from-gray-50 to-gray-100">
                    ...
                    <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Zipcode</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($addresses as $address)
                    <tr class="hover:bg-gray-50/50 transition-colors duration-150 ease-in-out">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{ $address->number }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{ $address->city }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{ $address->zipcode }}</div>
                        </td>
