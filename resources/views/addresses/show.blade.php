...
@section('header-title', 'Address Details')
@section('header-subtitle', 'View address information')
            ...
            <div class="px-4 py-5 sm:p-6">
                <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-1">
                    <div class="sm:col-span-1">
                        <dt class="text-sm font-medium text-gray-500">Street Name</dt>
                        <dd class="mt-1 text-sm text-gray-900">{{ $address->name }}</dd>
                    </div>
                    <div class="sm:col-span-1">
                        <dt class="text-sm font-medium text-gray-500">Number</dt>
                        <dd class="mt-1 text-sm text-gray-900">{{ $address->number }}</dd>
                    </div>
                    <div class="sm:col-span-1">
                    ...
                    <div class="sm:col-span-1">
                        ...
                        <dd class="mt-1 text-sm text-gray-900">{{ $address->created_at->format('F j, Y') }}</dd>
                    </div>
                    <div class="sm:col-span-1">
                        <dt class="text-sm font-medium text-gray-500">Last Updated</dt>
                        <dd class="mt-1 text-sm text-gray-900">{{ $address->updated_at->format('F j, Y') }}</dd>
                    </div>
                </dl>
            </div>
        </div>
